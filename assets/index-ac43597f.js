var ee=Object.defineProperty;var te=(s,e,t)=>e in s?ee(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var u=(s,e,t)=>(te(s,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))r(d);new MutationObserver(d=>{for(const o of d)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function t(d){const o={};return d.integrity&&(o.integrity=d.integrity),d.referrerPolicy&&(o.referrerPolicy=d.referrerPolicy),d.crossOrigin==="use-credentials"?o.credentials="include":d.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(d){if(d.ep)return;d.ep=!0;const o=t(d);fetch(d.href,o)}})();const W=s=>s?`
			<div class="product__options">
				${Object.entries(s).reduce((e,[t,r])=>{const d=t==="Размер"?`<span class="product__size">${t}: ${r}</span>`:`<span>${t}: ${r}</span>`;return e+d},"")}
			</div>
		`:"",se="/shopping-cart/assets/Information-041d4582.svg",re=({id:s,name:e,img:t,price:r,currency:d,prevPrice:o,options:n,company:a,totalQuantity:i,link:l,priceDetails:p,companyDetails:v},m)=>`
	...
	`,G=()=>{const s=document.querySelector(".goods__header_outOfStock > span");s.textContent=`Отсутствуют · ${q(c.productsOutOfStock.length)}`},_e=()=>{const s=document.querySelector(".goods__list_outOfStock");s.innerHTML=c.productsOutOfStock.reduce((e,t)=>e+me(t),""),G()},ve=(s,{start:e,end:t,products:r})=>`
		<div class="card__line">
			...
			<div class="card__imagesList">
				${r.reduce((d,{id:o,quantity:n})=>{var a;return d+`
						<div class="card__image">
							${n>1?`
									<span class="notification card__notification">${n}</span>
								`:""}
							<img src="${(a=s.find(i=>i.id===o))==null?void 0:a.img}" alt="Product image" />
						</div>
					`},"")}
			</div>
		</div>
	`,D={"01":"января","02":"февраля","03":"марта","04":"апреля","05":"мая","06":"июня","07":"июля","08":"августа","09":"сентября",10:"октября",11:"ноября",12:"декабря"},he={января:"янв",февраля:"фев",марта:"марта",апреля:"апр",мая:"мая",июня:"июня",июля:"июля",августа:"авг",сентября:"сент",октября:"окт",ноября:"нояб",декабря:"дек","":""},U=(s,e)=>{const t={};return e.reduce((r,{id:d,delivery:o})=>{const n=[...r];return o.forEach(a=>{const i=n.findIndex(p=>p.start===a.start&&p.end===a.end);let l;s[d]-(t[d]??0)>a.quantity?l=a.quantity:l=s[d]-(t[d]??0),t[d]=(t[d]??0)+l,i>=0?n[i]={...n[i],products:[...n[i].products,{id:d,quantity:l}]}:n.push({start:a.start,end:a.end,products:[{id:d,quantity:l}]})}),n.sort((a,i)=>{const l=a.start.split("."),p=i.start.split(".");return+new Date(+l[2],+l[1]-1,+l[0])-+new Date(+p[2],+p[1]-1,+p[0])})},[]).map(r=>({...r,products:r.products.filter(d=>d.quantity!==0)})).filter(r=>r.products.length!==0).map(({start:r,end:d,products:o})=>{let n=`${+r.split(".")[0]} ${D[r.split(".")[1]]}`,a=`${+d.split(".")[0]} ${D[d.split(".")[1]]}`;return n.split(" ")[1]===a.split(" ")[1]?n=n.split(" ")[0]:a=`<br/>${a}`,{start:n,end:a,products:o}})},_=()=>{const s=h(c.productsNum,c.selectedProducts),e=document.querySelector(".card__products");e.innerHTML=U(s,c.products).reduce((t,r)=>t+ve(c.products,r),"")},fe="/shopping-cart/assets/Mir-f3178dfd.svg",ye="/shopping-cart/assets/Visa-0911e67b.svg",ge="/shopping-cart/assets/Mastercard-8f4656d1.svg",$e="/shopping-cart/assets/Maestro-55eee7e2.svg",be={mir:fe,visa:ye,mastercard:ge,maestro:$e},N=({type:s,date:e,number:t},r,d)=>`
	...
	`,Se=()=>{const s=document.querySelector(".paymentForm__body");s.innerHTML=c.cards.reduce((e,t)=>e+`
		<label class="radio paymentForm__radio">
			...
			${N(t,!1,"modal__paymentCard")}
		</label>
	`,"")},j=()=>{const s=document.querySelector(".orderDetails__cardWrapper");s.innerHTML=N(c.cards.find(e=>e.id===c.selectedCard),!0,"orderDetails__card")},Q=()=>{const s=document.querySelector(".payment__cardWrapper");s.innerHTML=N(c.cards.find(e=>e.id===c.selectedCard),!1,"payment__card")},Pe="/shopping-cart/assets/Star-be4dc973.svg",x=({address:s,rating:e,information:t,type:r},d="",o="",n)=>`
	...
	`,Oe=()=>{const s=document.querySelectorAll("[data-modal-tab]"),e=document.querySelector(".addressForm__addressesWrapper"),t=c.addresses.find(r=>r.id===c.selectedAddress).type;s.forEach(r=>{const d=r.dataset.modalTab??"";t===d?r.classList.add("tabs__tab_active"):r.classList.remove("tabs__tab_active")}),e.innerHTML=c.addresses.reduce((r,d)=>r+`
			<div data-delete-address="${d.id}" data-address-type="${d.type}" class="modal__line ${t!==d.type?"hide":""}">
				<label class="radio addressForm__radio">
					...
					${x(d,"","addressForm__rating","Пункт выдачи")}
				</label>
	...
	`},C=()=>{const s=document.querySelector(".payment__immediately input"),e=document.querySelector(".total__button"),t=document.querySelectorAll(".payment__immediately span, .card__additional");s.checked?(t.forEach(r=>{r.classList.add("hide"),e.textContent=`Оплатить ${c.getTotalPrice().toLocaleString("ru")} ${c.currency}`}),c.setPayImmediately(!0)):(t.forEach(r=>{r.classList.remove("hide"),e.textContent="Заказать"}),c.setPayImmediately(!1))},P=(s,e,t,r,d)=>{c.setProductsNum(s,+r.innerText),e.disabled=c.productsNum[s]===d.totalQuantity,t.disabled=c.productsNum[s]===1,qe(c.productsNum[s],s,d),_(),b(),y(),g(),$(),C()},Ne=()=>{document.querySelectorAll("[data-product]:has(.checkbox)").forEach(e=>{const t=e.dataset.product??"",r=c.products.find(a=>a.id===t),d=e.querySelector(".counter__decr"),o=e.querySelector(".counter__data"),n=e.querySelector(".counter__incr");n.disabled=c.productsNum[t]===r.totalQuantity,d.disabled=c.productsNum[t]===1,d.addEventListener("click",()=>{o.innerText=`${+o.innerText-1}`,P(t,n,d,o,r)}),n.addEventListener("click",()=>{o.innerText=`${+o.innerText+1}`,P(t,n,d,o,r)}),o.addEventListener("blur",()=>{let a=+o.innerText.replace(/\D/g,"");a<1&&(a=1),a>r.totalQuantity&&(a=r.totalQuantity),o.innerText=`${a}`,P(t,n,d,o,r)}),o.addEventListener("keydown",function(a){a.key==="Enter"&&(a.preventDefault(),o.blur())})})},F=s=>{s.remove(),w(),G(),_(),C(),y(),g(),$()},xe=()=>{document.querySelectorAll("[data-product]").forEach(e=>{const t=e.dataset.product??"",r=e.querySelector(".product__favorite"),d=e.querySelector(".product__delete");r.addEventListener("click",()=>{c.setProductsFavorite(t),F(e)}),d.addEventListener("click",()=>{c.removeProducts(t),F(e)})})},Ce=()=>{const s=document.createElement("div");s.style.visibility="hidden",s.style.overflow="scroll",document.body.appendChild(s);const e=document.createElement("div");s.appendChild(e);const t=s.offsetWidth-e.offsetWidth;return s.parentNode.removeChild(s),t},Me=s=>{s.classList.remove("modal_hide"),document.body.style.overflowY="hidden",document.body.style.marginRight=`${Ce()}px`},M=s=>{const e=s.closest(".modal"),t=e.dataset.modal??"";e.classList.add("modal_hide"),document.body.style.overflowY="auto",document.body.style.marginRight="0",t==="payment"?(j(),Q()):(V(),z())},Ee=()=>{const s=document.querySelectorAll(".modal");document.querySelectorAll("button[data-modal]").forEach(r=>{const d=r.dataset.modal;r.addEventListener("click",()=>{s.forEach(o=>{o.dataset.modal===d&&Me(o)})})}),document.querySelectorAll(".modal__overlay, .modal__close").forEach(r=>{r.addEventListener("click",d=>{d.stopPropagation(),M(r)})})},De=()=>{const s=document.querySelector('[data-modal="payment"] .paymentForm');s.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(s),r=Object.fromEntries(t);c.setSelectedCard(r.card),M(s)})},Ie=()=>{document.querySelector(".payment__immediately input").addEventListener("click",()=>{C()})},Fe=s=>{document.querySelectorAll("[data-address-type]").forEach(t=>{const r=t.dataset.addressType??"";s===r?t.classList.remove("hide"):t.classList.add("hide")})},We=()=>{const s=document.querySelectorAll("[data-modal-tab]");s.forEach(e=>{const t=e.dataset.modalTab??"user";e.addEventListener("click",()=>{s.forEach(r=>{r===e?r.classList.add("tabs__tab_active"):r.classList.remove("tabs__tab_active")}),Fe(t)})})},Be=()=>{const s=document.querySelector('[data-modal="address"] .addressForm');s.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(s),r=Object.fromEntries(t);c.setSelectedAddress(r.address),M(s)}),We()},Re=()=>{const s=document.querySelectorAll(".modal__line[data-delete-address]");s.forEach(e=>{const t=e.querySelector("button[data-delete-address]"),r=t.dataset.deleteAddress??"",d=e.dataset.addressType??"";t.addEventListener("click",()=>{e.remove(),c.removeAddress(r);const o=c.addresses.filter(a=>a.type===d);s.forEach(a=>{const i=a.dataset.deleteAddress??"",l=a.querySelector("input");l.checked=i===o[0].id}),c.addresses.filter(a=>a.type===d).length===1&&document.querySelector(`[data-address-type="${d}"] > button`).classList.add("hide")})})},Z=(s,e)=>{const t=s.dataset.formBlock,r=s.querySelector(".form__error");if(e[t]){s.classList.add("form__block_error"),r.textContent=e[t];return}t==="INN"?r.textContent="Для таможенного оформления":r.textContent="",s.classList.remove("form__block_error")},He=s=>{const e=s.value.trim();if(e==="")return"";const t=e.replace(/\D/g,""),r=`+${t.substring(0,1)==="8"?"7":t.substring(0,1)} ${t.substring(1,4)} ${t.substring(4,7)} ${t.substring(7,9)} ${t.substring(9,11)}`;return s.value=r.trim(),s.value},we=()=>{document.querySelectorAll("[data-form-block]").forEach(e=>{const t=e.querySelector("input");t.addEventListener("input",()=>{let r=t.value;e.dataset.formBlock==="phone"&&(r=He(t)),r.trim()!==""?e.querySelector(".form__input").classList.add("form__hasText"):e.querySelector(".form__input").classList.remove("form__hasText"),c.setUserData(t.name,t.value)}),t.addEventListener("blur",()=>{const r=c.validationErrors;Z(e,r)})})},Ye=()=>{const s=window.matchMedia("(max-width: 768px)"),e=document.querySelector(".total__button"),t=document.querySelectorAll("[data-form-block]");e.addEventListener("click",()=>{const r=c.getValidationErrors();t.forEach(d=>{Z(d,r)}),c.canIOrderProducts()?alert(`Ordered products ids: ${JSON.stringify(c.getSelectedProductsWithNums())}
Total price: ${c.getTotalPrice()}
Payment card: ${c.selectedCard}
Address: ${c.selectedAddress}
Pay immediately: ${c.payImmediately}
User data: ${JSON.stringify(c.userData)}`):s.matches&&c.hasValidationErrors()?document.querySelector(".orderDetails__customer").scrollIntoView({behavior:"smooth"}):s.matches&&c.selectedProducts.length<=0&&document.querySelector(".orderDetails").scrollIntoView({behavior:"smooth"})})};document.addEventListener("DOMContentLoaded",()=>{pe(),_e(),_(),b(),y(),g(),$(),Se(),j(),Q(),Oe(),V(),z(),Ae(),ke(),Ne(),xe(),Ee(),De(),Ie(),Be(),Re(),we(),Ye()});
